...
<div class="boxed-page">
        ...
        <div class="row d-flex align-items-center">
            ...
            <div class="col-lg-6 hero-right">
                <div class="owl-carousel owl-theme hero-carousel">
                    <div class="item">
                        <img class="img-fluid" src="resto/img/hero-1.jpg" alt="">
                    </div>
                    <div class="item">
                        <img class="img-fluid" src="resto/img/hero-2.jpg" alt="">
                    </div>
                    <div class="item">
                        <img class="img-fluid" src="resto/img/hero-3.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <a href="#" class="thumb-menu">
                                        <img class="img-fluid img-cover" src="resto/img/hero-1.jpg" />
            ...
            <div class="section-content">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-5 offset-lg-2 col-md-6 align-self-center mt-4 mt-md-0">
                        <img src="resto/img/steak.jpg" alt="" class="img-fluid shadow w-100">
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col-lg-5 col-md-6 align-self-center order-2 order-md-1 mt-4 mt-md-0">
                        <img src="resto/img/salmon-zucchini.jpg" alt="" class="img-fluid shadow w-100">
                    </div>
    ...
    <section id="gtco-testimonial" class="overlay bg-fixed section-padding" style="background-image: url(/resto/img/testi-bg.jpg);">
        <div class="container">
            <div class="section-content">
                <div class="heading-section text-center">
                <span class="subheading">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="team-card mb-5">
                            <img class="img-fluid" src="resto/img/chef-1.jpg" alt="">
                            <div class="team-desc">
                    ...
                    <div class="col-md-4">
                        <div class="team-card mb-5">
                            <img class="img-fluid" src="resto/img/chef-2.jpg" alt="">
                            <div class="team-desc">
                    ...
                    <div class="col-md-4">
                        <div class="team-card mb-5">
                            <img class="img-fluid" src="resto/img/chef-3.jpg" alt="">
                            <div class="team-desc">
    ...
    <section id="gtco-reservation" class="bg-fixed bg-white section-padding overlay" style="background-image: url(/resto/img/reservation-bg.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
