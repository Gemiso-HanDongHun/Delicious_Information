...
<%--<head>--%>
<%--    &lt;%&ndash;    <%@ include file="./include/static-head.jsp" %>&ndash;%&gt;--%>
...
<%--&lt;%&ndash;<%@ include file="./include/header.jsp" %>&ndash;%&gt;--%>
...
<%--                                    &lt;%&ndash;                                    <input type="radio" size="17" maxlength="20" id="checkbox"&ndash;%&gt;--%>
<%--                                    &lt;%&ndash;                                           name="gender" class="form-control tooltipstered" maxlength="20"&ndash;%&gt;--%>
<%--                                    &lt;%&ndash;                                           required="required" aria-required="true"&ndash;%&gt;--%>
<%--                                    &lt;%&ndash;                                           style="ime-mode: inactive; margin-bottom: 25px; height: 40px; border: 1px solid #d9d9de"&ndash;%&gt;--%>
<%--                                    &lt;%&ndash;                                           placeholder="성별입력.">&ndash;%&gt;--%>
<%--                                </td>--%>
...
<%--                                </button>--%>
<%--                                &lt;%&ndash;                                <td style="width: 40%; text-align: center; colspan: 2;">&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                    <input type="button" value="회원가입" class="btn form-control tooltipstered"&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                           id="signup-btn"&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                           style="background: pink; margin-top: 0; height: 40px; color: white; border: 0px solid #388E3C; opacity: 0.8">&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                </td>&ndash;%&gt;--%>
<%--                            </tr>--%>
