...
import com.champion.deliciousInfo.member.domain.OAuthValue;
    ...
    private static void sendAccessTokenRequest(String authCode, HttpURLConnection conn) throws IOException {
        ...
        try (BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(conn.getOutputStream()))) {
            ...
            queryParam
                    ...
                    .append("&redirect_uri=http://ec2-35-79-166-220.ap-northeast-1.compute.amazonaws.com" + KAKAO_REDIRECT_URI)
